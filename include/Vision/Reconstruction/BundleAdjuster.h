    ...
    namespace Vision
    {
        ...
        namespace Reconstruction
        {
            class BundleAdjuster
            {
                public:
                    BundleAdjuster();
                    BundleAdjuster(const std::shared_ptr<Core::FeatureSet> &featureSet);

                    void EstimateCameraPose(std::shared_ptr<Core::PointOfView> &pointOfView);
                    void RunOnNewData();
                    void RunOnAllData();
                    void Reset(const std::shared_ptr<Core::FeatureSet> &featureSet);
                ...
                private:
                    ...
                    struct SbaParameters
                    {
                        public:
                            ...
                            std::vector<std::shared_ptr<Core::Feature> > triangulatedPoints;
                    ...
                    std::vector<std::shared_ptr<Core::Feature> > pointsx;
